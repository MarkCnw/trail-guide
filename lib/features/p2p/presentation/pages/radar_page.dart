...
class _RadarPageState extends State<RadarPage>
          ...
          return Column(
            children: [
              ...
              Expanded(
                flex: 3,
                child: Center(
                  // ✅ ส่งพิกัดตัวเองเข้าไปด้วยแบบนี้เลย!
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            // โยนพิกัดเพื่อน และพิกัดเรา เข้าไปคำนวณ!
  ...
  // ==========================================
  // 🟢 2. ฟังก์ชันวาดวงกลมเรดาร์ และจุดของเพื่อนๆ
  // ==========================================
  ...
  // ==========================================
  // 🟢 3. ฟังก์ชันสร้างจุด 1 จุดบนเรดาร์
  // ==========================================
  ...
  // 🟢 ฟังก์ชันสร้างการ์ด (รับค่าพิกัดของเรา myLat, myLng เข้ามาด้วย)
  // 🟢 ฟังก์ชันสร้างการ์ด (รับค่าพิกัดของเรา myLat, myLng เข้ามาด้วย)
